...
namespace runnerDotNet
{
	public interface IGlobalEventProviderCS
	{
		...
		// onscreen events
		XVar event_v1_snippet1(dynamic varparams);
	...
	public class class_GlobalEvents : EventsAggregatorBase
	{
		...
		//	onscreen events
		public XVar event_v1_snippet1(dynamic varparams)
		{
			MVCFunctions.Echo(EventProviderCS.event_v1_snippet1(varparams));
