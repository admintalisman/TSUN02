		...
		*/
		...
		public static XVar imageCreateThumb(XVar new_width, XVar new_height, XVar img_width, XVar img_height, XVar file_path, XVar options, XVar new_file_path, XVar uploadedFile)
		{
            ...
            if(destWidth > 0 && destHeight > 0)
            {
                ...
                //Image resizedImage = originalImage.GetThumbnailImage((int)destWidth, (int)destHeight, null, IntPtr.Zero);
...
*/
        ...
        public static XVar callDashboardSnippet(dynamic dashName, dynamic dashElem)
        {
            ...
            if (eventObj != null)
            {
                ...
                MethodInfo method = ((IEnumerable<dynamic>)eventObj.GetType().GetMethods()).Where(m => m.Name == funcName.ToString()).First();
		...
		public static XVar base64_decode_binary(dynamic _param_data)
		{
			return base64_decode(_param_data);
		}
...
//                return raw_output ? new XVar(System.Text.Encoding.UTF8.GetString( hmacsha256.Hash ) ) : bin2hex(new XVar(hmacsha256.Hash));
        ...
        public static XVar getImageDimensions(dynamic _param_image)
        {
            ...
            try
            {
                using (MemoryStream ms = new MemoryStream(_param_image.Value))
                {
                    using (Image sourceImage = Image.FromStream(ms, false, false))
                    {
		...
		public static XVar getHttpHeader(dynamic _param_name)
		{
			...
			return HttpContext.Current.Request.Headers.Get(_param_name.ToString());
		}
