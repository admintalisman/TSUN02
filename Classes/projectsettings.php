...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "BSM" ] = array( "url" => "bsm", "type" => 0 );
	$projectEntitiesReverse[ "bsm" ] = "BSM";
	...
	$projectEntities[ "PLACING" ] = array( "url" => "placing", "type" => 0 );
	$projectEntitiesReverse[ "placing" ] = "PLACING";
}
