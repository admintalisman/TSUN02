...
namespace runnerDotNet
{
    public class tDAL : XClass
    {
        ...
        {
			var connection = GlobalVars.cman.byId( "TSUNDB_at_alpha_talisman_co_id" );
			return connection.addTableWrappers("dbo.m_login");
        }
		...
		public XVar tblm_employee
		{
			get
			{
				return Table("tblm_employee");
			}
		}
		public XVar tblm_location_office
		{
			get
			{
				return Table("tblm_location_office");
			}
		}
		public XVar tblm_login
		{
			get
			{
				return Table("tblm_login");
			}
		}
		public XVar tblm_mapping_location
		{
			get
			{
				return Table("tblm_mapping_location");
			}
		}
		public XVar tblm_meeting_room
		{
			get
			{
				return Table("tblm_meeting_room");
			}
		}
		public XVar t_audit
		{
		...
		public XVar t_register_doc
		{
			get
			{
				return Table("t_register_doc");
			}
		}
		public XVar t_uggroups
		{
			get
			{
				return Table("t_uggroups");
			}
		}
		public XVar t_ugmembers
		{
			get
			{
				return Table("t_ugmembers");
			}
		}
		public XVar t_ugrights
		{
			get
			{
				return Table("t_ugrights");
			}
		}
		public XVar t_visitor_log
		{
			get
			{
				return Table("t_visitor_log");
			}
		}
        ...
        public void FillTablesList()
        {
			...
			this.lstTables.Add(new XVar("name", "m_employee", "varname", "TSUNDB_at_alpha_talisman_co_id_dbo_tblm_employee", "connId", "TSUNDB_at_alpha_talisman_co_id", "schema", "dbo", "connName", "TSUNDB at alpha.talisman.co.id"));
			this.lstTables.Add(new XVar("name", "m_location_office", "varname", "TSUNDB_at_alpha_talisman_co_id_dbo_tblm_location_office", "connId", "TSUNDB_at_alpha_talisman_co_id", "schema", "dbo", "connName", "TSUNDB at alpha.talisman.co.id"));
			this.lstTables.Add(new XVar("name", "m_login", "varname", "TSUNDB_at_alpha_talisman_co_id_dbo_tblm_login", "connId", "TSUNDB_at_alpha_talisman_co_id", "schema", "dbo", "connName", "TSUNDB at alpha.talisman.co.id"));
			this.lstTables.Add(new XVar("name", "m_mapping_location", "varname", "TSUNDB_at_alpha_talisman_co_id_dbo_tblm_mapping_location", "connId", "TSUNDB_at_alpha_talisman_co_id", "schema", "dbo", "connName", "TSUNDB at alpha.talisman.co.id"));
			this.lstTables.Add(new XVar("name", "m_meeting_room", "varname", "TSUNDB_at_alpha_talisman_co_id_dbo_tblm_meeting_room", "connId", "TSUNDB_at_alpha_talisman_co_id", "schema", "dbo", "connName", "TSUNDB at alpha.talisman.co.id"));
			this.lstTables.Add(new XVar("name", "t_audit", "varname", "TSUNDB_at_alpha_talisman_co_id_dbo_t_audit", "connId", "TSUNDB_at_alpha_talisman_co_id", "schema", "dbo", "connName", "TSUNDB at alpha.talisman.co.id"));
			this.lstTables.Add(new XVar("name", "t_noti", "varname", "TSUNDB_at_alpha_talisman_co_id_dbo_t_noti", "connId", "TSUNDB_at_alpha_talisman_co_id", "schema", "dbo", "connName", "TSUNDB at alpha.talisman.co.id"));
			this.lstTables.Add(new XVar("name", "t_register_doc", "varname", "TSUNDB_at_alpha_talisman_co_id_dbo_t_register_doc", "connId", "TSUNDB_at_alpha_talisman_co_id", "schema", "dbo", "connName", "TSUNDB at alpha.talisman.co.id"));
			this.lstTables.Add(new XVar("name", "t_uggroups", "varname", "TSUNDB_at_alpha_talisman_co_id_dbo_t_uggroups", "connId", "TSUNDB_at_alpha_talisman_co_id", "schema", "dbo", "connName", "TSUNDB at alpha.talisman.co.id"));
			this.lstTables.Add(new XVar("name", "t_ugmembers", "varname", "TSUNDB_at_alpha_talisman_co_id_dbo_t_ugmembers", "connId", "TSUNDB_at_alpha_talisman_co_id", "schema", "dbo", "connName", "TSUNDB at alpha.talisman.co.id"));
			this.lstTables.Add(new XVar("name", "t_ugrights", "varname", "TSUNDB_at_alpha_talisman_co_id_dbo_t_ugrights", "connId", "TSUNDB_at_alpha_talisman_co_id", "schema", "dbo", "connName", "TSUNDB at alpha.talisman.co.id"));
			this.lstTables.Add(new XVar("name", "t_visitor_log", "varname", "TSUNDB_at_alpha_talisman_co_id_dbo_t_visitor_log", "connId", "TSUNDB_at_alpha_talisman_co_id", "schema", "dbo", "connName", "TSUNDB at alpha.talisman.co.id"));
        }
