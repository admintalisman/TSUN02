...
require_once("include/placing_variables.php");
...
$keys = array();
$keys["PLCID"] = postvalue("editid1");
$keys["MPLCID"] = postvalue("editid2");
$keys["RPLCID"] = postvalue("editid3");
$keys["OBLIGEEID"] = postvalue("editid4");
$keys["BANKID"] = postvalue("editid5");
